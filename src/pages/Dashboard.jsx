...
import { PageHeader, Divider, LinkCard, AnimatedNumber, LivePulse, ValueFlash, Btn, Card, CardBody, SectionHeader, Badge } from '../components/ui';
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <PageHeader icon={LayoutDashboard} title="Dashboard" subtitle="Your portfolio overview — live positions, P&L, and bot performance">
        <div className="flex items-center gap-3">
          <LivePulse connected={wsConnected} label={wsConnected ? 'Live' : 'Polling'} size="sm" />
      ...
      {!simple && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 stagger-reveal">
          {/* Pie Chart */}
          <Card>
            <CardBody>
